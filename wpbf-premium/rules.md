# WPBF Premium - AI Agent Rules & Workflow

## Project Context

We are working on the "wpbf-premium" WordPress plugin located in `wp-content/plugins/wpbf-premium`.

## Directory Structure

The `ai-docs/wpbf-premium/{developer}/` directory contains documentation to facilitate context handoffs between AI agents.
...
- **Read Context**: Always check `ai-docs/wpbf-premium/{developer}/progress-handoffs/PROGRESS_HANDOFF.md` to understand the current status, recent changes, and immediate next steps.
...
- **1. Update Handoff File**:
  - Update `ai-docs/wpbf-premium/{developer}/progress-handoffs/PROGRESS_HANDOFF.md`.
...
- **Building**:
  ...
  - Check `package.json` for available build scripts before running build commands.
