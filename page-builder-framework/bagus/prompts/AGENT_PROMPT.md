...
1. **Investigate search widget expansion behavior**:
   - Check the difference between frontend vs customize preview.
   - Maybe check between curren dev branch and master branch (note: master doesn't have header builder feature yet).
